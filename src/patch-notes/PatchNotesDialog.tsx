...
export default function PatchNotesDialog({ dialogRef }: { dialogRef: RefObject<HTMLDialogElement | null> }) {
  return (
    <dialog className="stats-dialog patch-notes-dialog" aria-labelledby="patch-notes-title" ref={dialogRef} onCancel={() => dialogRef.current?.close()}>
      <div className="stats-content patch-notes-content">
        ...
        <h2 id="patch-notes-title">패치노트</h2>
